...
<head>
    ...
    <style>
        ...
        .container-md { background-color: greenyellow; }
        .container-lg { background-color: yellow; }
        .container-xl { background-color: pink; }
        .container-xxl { background-color: orange; }
        .container-fluid { background-color: purple; }
    </style>
</head>

<body>
    <div class="container">100% wide until xsmall breakpoint</div>
